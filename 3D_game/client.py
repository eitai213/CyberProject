...
class Client:
    ...
    def run_client(self):
        if self.server_ip:
            ...
            try:
                # קבלת המפתח הציבורי מהשרת
                received_data = client_socket.recv(1024)
                print(f"Received public key: {received_data}")  # Debugging line
                ...
                # שליחת מפתח ה-AES מוצפן עם המפתח הציבורי של השרת
